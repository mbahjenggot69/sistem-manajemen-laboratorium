                        ...
                        <div class="container-fluid px-4">
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#req">
                                        Keranjang Bahan Kimia
                                    </button>
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#dafrequser">
                                        Daftar Request User
                                    </button>
                                ...
                                <div class="card-body">
                                    <table id="datatablesSimple">
                                        ...
                                        <tbody>
                                            <?php
                                            $ambildaritabel = mysqli_query($koneksi, "SELECT * FROM daftar_bhkimia WHERE id_faku = '$id_faku'");
                                            $nomor = 1;
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="post" onsubmit="return validasi_jumlah_edit()">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" placeholder="Tulis Nama" class="form-control" value=<?php echo $_SESSION['nama_lgkp']; ?> id="nama_lgkp" name="nama_lgkp" required>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <small><label for="nama_labo" class="form-label">Laboratorium</label></small>
                                                                        <input type="text" placeholder="Laboratorium Anda" class="form-control" value="<?= $nama_labo; ?>" id="nama_labo" name="nama_labo" required>
                                                                    </div>
                                                                    <br>
                                                                    <div class="mb-3">
