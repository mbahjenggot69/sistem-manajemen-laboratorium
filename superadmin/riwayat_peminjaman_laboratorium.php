                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="post">
                                                                        <div class="mb-3">
                                                                            Apakah Anda yakin ingin menghapus semua riwayat praktikum <?= $nama_labo; ?> dengan kode <?= $kode_labo; ?>?
                                                                        </div>
                                                                        <br>
                                                                        <button type="submit" class="btn btn-danger" name="hapusriwayatjadwal" style="width: 100%;">Hapus</button>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        </div>
