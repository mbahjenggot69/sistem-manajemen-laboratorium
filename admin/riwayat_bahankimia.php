                                        ...
                                        <table id="datatablesSimple">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Jumlah Permintaan (per Satuan)</th>
                                                    <th>Pengguna</th>
                                                    <th>Status</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $ambildaritabel = mysqli_query($koneksi, "SELECT * FROM daftar_request WHERE id_labo = '$id_labo' AND id_faku = '$id_faku' AND username = '$username' AND status = 'Selesai' ");
                                                $nomor = 1;
