                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <table id="datatablesSimple">
                                        ...
                                        <tbody>
                                            <?php
                                            $ambildaritabel = mysqli_query($koneksi, "SELECT * FROM daftar_modul WHERE id_faku = '$id_faku' AND id_labo = $id_labo AND pemilik = '$username'");
                                            $nomor = 1;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="detail_modul.php?id_modl=<?= $id_modl; ?>&id_labo=<?= $id_labo; ?>&id_faku=<?= $id_faku; ?>" class="btn btn-info">Daftar Peralatan</a>
                                                    </td>
                                                </tr>
                                                <!-- The Modal Edit -->
